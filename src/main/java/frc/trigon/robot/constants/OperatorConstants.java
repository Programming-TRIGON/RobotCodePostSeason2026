...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            SHOOTING_CALCULATIONS_CALIBRATION_TRIGGER = OPERATOR_CONTROLLER.f3(),
    ...
    public final static Trigger
            ...
            SET_TARGET_FIXED_SCORING_LOCATION_CLOSE_TO_HUB_TRIGGER = DRIVER_CONTROLLER.povDown().or(OPERATOR_CONTROLLER.i()),
            SET_TARGET_FIXED_SCORING_LOCATION_RIGHT_TRENCH_TRIGGER = DRIVER_CONTROLLER.povRight().or(OPERATOR_CONTROLLER.l()),
            SET_TARGET_FIXED_SCORING_LOCATION_LEFT_TRENCH_TRIGGER = DRIVER_CONTROLLER.povLeft().or(OPERATOR_CONTROLLER.j()),
            SET_TARGET_FIXED_SCORING_LOCATION_BACK_RIGHT_TRIGGER = DRIVER_CONTROLLER.povDownRight().or(OPERATOR_CONTROLLER.o()),
            SET_TARGET_FIXED_SCORING_LOCATION_BACK_LEFT_TRIGGER = DRIVER_CONTROLLER.povDownLeft().or(OPERATOR_CONTROLLER.u()),
