...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            PREPARE_FOR_FIXED_SHOOTING_TRIGGER = OPERATOR_CONTROLLER.semicolon(),
            PREPARE_FOR_SHOOTING_TRIGGER = OPERATOR_CONTROLLER.v(),
            EJECT_FROM_INTAKE_TRIGGER = OPERATOR_CONTROLLER.r().or(DRIVER_CONTROLLER.a()),
            EJECT_FROM_SHOOTER_TRIGGER = DRIVER_CONTROLLER.x().or(OPERATOR_CONTROLLER.e()),
