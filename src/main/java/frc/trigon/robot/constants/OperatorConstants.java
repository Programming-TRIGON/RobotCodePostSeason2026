...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            TOP_RIGHT_SETTER_TRIGGER = DRIVER_CONTROLLER.povDownRight(),
            TOP_LEFT_TOWER_SETTER_TRIGGER = DRIVER_CONTROLLER.povDownLeft(),
            FIXED_SHOOTING_TRIGGER = DRIVER_CONTROLLER.rightStick(),
            FIXED_DELIVERY_TRIGGER = DRIVER_CONTROLLER.leftStick(),
