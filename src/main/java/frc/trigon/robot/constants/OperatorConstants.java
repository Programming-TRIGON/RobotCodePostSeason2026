...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            FIXED_SHOOTING_TRIGGER = DRIVER_CONTROLLER.leftStick().or(OPERATOR_CONTROLLER.d()),
            FIXED_DELIVERY_TRIGGER = DRIVER_CONTROLLER.rightStick().or(OPERATOR_CONTROLLER.a()),
