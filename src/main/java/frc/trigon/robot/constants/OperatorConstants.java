...
public class OperatorConstants {
    ...
    public static final Trigger
            ...
            CLOSE_TO_HUB_SETPOINT_SETTER_TRIGGER = DRIVER_CONTROLLER.povDown(),
            RIGHT_CORNER_TO_HUB_SETTER_TRIGGER = DRIVER_CONTROLLER.povRight(),
            LEFT_CORNER_TO_HUB_SETTER_TRIGGER = DRIVER_CONTROLLER.povLeft(),
            RIGHT_CORNER_TO_TOWER_SETTER_TRIGGER = DRIVER_CONTROLLER.povDownRight(),
            LEFT_CORNER_TO_TOWER_SETTER_TRIGGER = DRIVER_CONTROLLER.povDownLeft(),
            FIXED_SHOOTING_TRIGGER = DRIVER_CONTROLLER.rightStick(),
            FIXED_DELIVERY_TRIGGER = OPERATOR_CONTROLLER.eight(),
            ...
            CAMERAS_DISCONNECTED_TRIGGER = new

                    Trigger(() -> !RobotContainer.ROBOT_POSE_ESTIMATOR.hasUpdateFromCameras()).

                    debounce(ARE_CAMERAS_DISCONNECTED_CHECK_DEBOUNCE_SECONDS);
}