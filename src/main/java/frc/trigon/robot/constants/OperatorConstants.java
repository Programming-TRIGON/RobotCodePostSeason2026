...
public class OperatorConstants {
    ...
    public final static Trigger
            ...
            RIGHT_TRENCH_SETTER_TRIGGER = DRIVER_CONTROLLER.povRight().or(OPERATOR_CONTROLLER.l()),
            ...
            TOP_LEFT_SETTER_TRIGGER = DRIVER_CONTROLLER.povDownLeft().or(OPERATOR_CONTROLLER.u()),
    ...
    public final static Trigger
            ...
            INTAKE_TRIGGER = DRIVER_CONTROLLER.leftTrigger()
                    .or(SHOOTING_TRIGGER.and(CLOSE_INTAKE_WHILE_SHOOTING_TRIGGER.negate()));
}