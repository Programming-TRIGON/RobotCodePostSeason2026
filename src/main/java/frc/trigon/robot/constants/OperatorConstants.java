...
public class OperatorConstants {
    ...
    public static final Trigger
            SHOOTING_TRIGGER = DRIVER_CONTROLLER.start().or(OPERATOR_CONTROLLER.d()),
            ...
            FIXED_SHOOTING_AT_HUB_TRIGGER = DRIVER_CONTROLLER.rightBumper().or(OPERATOR_CONTROLLER.s()),
            FIXED_DELIVERY_TRIGGER = DRIVER_CONTROLLER.leftBumper().or(OPERATOR_CONTROLLER.f()),
            CLOSE_ARM = DRIVER_CONTROLLER.a().or(OPERATOR_CONTROLLER.e()),
            OPEN_ARM = DRIVER_CONTROLLER.x().or(OPERATOR_CONTROLLER.r()),
            ARM_UP = DRIVER_CONTROLLER.povUp().or(OPERATOR_CONTROLLER.f()),
            ARM_DOWN = DRIVER_CONTROLLER.povDown().or(OPERATOR_CONTROLLER.d()),
            ENABLE_OVERRIDE_SWERVE_AIM_TRIGGER = OPERATOR_CONTROLLER.m(),
            DISABLE_OVERRIDE_SWERVE_AIM_TRIGGER = OPERATOR_CONTROLLER.n(),
            LOWER_HOOD_TRIGGER = OPERATOR_CONTROLLER.q(),
            IS_ANY_SHOOTING_TRIGGER_ACTIVE = SHOOTING_TRIGGER.or(FIXED_SHOOTING_AT_HUB_TRIGGER).or(FIXED_DELIVERY_TRIGGER).or(OPEN_ARM),
