...
public class ShooterConstants {
    ...
    public static final double
            TOP_WHEEL_GEAR_RATIO = 17,
            BOTTOM_WHEEL_GEAR_RATIO = 12;
    ...
    private static void configureMasterMotor() {
        ...
        config.Slot0.kS = RobotHardwareStats.isSimulation() ? 0.03735 : 0;
        config.Slot0.kV = RobotHardwareStats.isSimulation() ? 1.7937 : 0;
        config.Slot0.kA = RobotHardwareStats.isSimulation() ? 0.028573 : 0;
