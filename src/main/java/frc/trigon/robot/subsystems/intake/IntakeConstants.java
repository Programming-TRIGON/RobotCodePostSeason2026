...
public class IntakeConstants {
    ...
    private static final Color ANGLE_MOTOR_MECHANISM_COLOR = Color.kBlue;
    ...
    public enum IntakeState {
        ...
        public final double targetWheelVoltage;
        public final double targetIntakeVoltage;

        IntakeState(double targetWheelVoltage, double targetIntakeVoltage) {
            this.targetWheelVoltage = targetWheelVoltage;
